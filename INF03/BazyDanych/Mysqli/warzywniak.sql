...
--
-- Host: 127.0.0.1
-- Czas generowania: 11 Wrz 2022, 10:46
...
(7, 3, 'Monika', 'Kopacz', 2009, 'dziś rano 5 km', 'osoba1.jpg'),
...
(27, 6, 'Monika', 'Kopacz', 2009, 'dziś rano 5 km', 'osoba1.jpg'),
...
(9, 12, 10, 'Star Wars 1', 1, 'Luke Skywalker i ksiezniczka Leia w walce z ciemną stroną mocy', 25, 'star-wars.jpg'),
(10, 7, 9, 'Alien', 1, 'Załoga statku kosmicznego Nostromo odbiera tajemniczy sygnał i ląduje na niewielkiej planetoidzie, gdzie jeden z jej członków zostaje zaatakowany przez obcą formę życia.', 20, 'alien.jpg'),
(11, 12, 10, 'E.T.', 1, 'Przybysz z innej planety zaprzyjaźnia się z chłopcem i jego rodziną.', 30, 'et.jpg'),
(12, 7, 9, 'Alien2', 1, 'Załoga statku kosmicznego Nostromo odbiera tajemniczy sygnał i ląduje na niewielkiej planetoidzie, gdzie jeden z jej członków zostaje zaatakowany przez obcą formę życia.', 20, 'alien.jpg'),
(13, 12, 10, 'hobbit2', 1, 'Hobbit Bilbo Baggins wyrusza w niebezpieczną podróż, by wraz z czarodziejem Gandalfem i trzynastoma krasnoludami pokonać smoka Smauga.', 30, 'hobbit.jpg'),
(14, 12, 10, 'Fantasy2', 1, 'Elfy, krasnoludy i inne fantastyczne itstoty w walce o swoją planetę.', 10, 'fantasy.jpg'),
(15, 7, 9, 'Alien3', 1, 'Załoga statku kosmicznego Nostromo odbiera tajemniczy sygnał i ląduje na niewielkiej planetoidzie, gdzie jeden z jej członków zostaje zaatakowany przez obcą formę życia.', 20, 'alien.jpg'),
(16, 12, 10, 'hobbit3', 1, 'Hobbit Bilbo Baggins wyrusza w niebezpieczną podróż, by wraz z czarodziejem Gandalfem i trzynastoma krasnoludami pokonać smoka Smauga.', 30, 'hobbit.jpg'),
(17, 12, 10, 'Star Wars 2', 1, 'Luke Skywalker i ksiezniczka Leia w walce z ciemną stroną mocy', 25, 'star-wars.jpg'),
(18, 7, 9, 'Alien4', 1, 'Załoga statku kosmicznego Nostromo odbiera tajemniczy sygnał i ląduje na niewielkiej planetoidzie, gdzie jeden z jej członków zostaje zaatakowany przez obcą formę życia.', 20, 'alien.jpg'),
(19, 12, 10, 'Fantasy', 1, 'Elfy, krasnoludy i inne fantastyczne itstoty w walce o swoją planetę.', 10, 'fantasy.jpg'),
(20, 12, 10, 'Star Wars 3', 1, 'Luke Skywalker i ksi??niczka Leia w walce z ciemn? stron? mocy', 25, 'star-wars.jpg'),
(21, 12, 10, 'hobbit', 1, 'Hobbit Bilbo Baggins wyrusza w niebezpieczną podróż, by wraz z czarodziejem Gandalfem i trzynastoma krasnoludami pokonać smoka Smauga.', 30, 'hobbit.jpg'),
...
(24, 12, 10, 'Star Wars 4', 1, 'Luke Skywalker i ksiezniczka Leia w walce z ciemną stroną mocy', 25, 'star-wars.jpg'),
